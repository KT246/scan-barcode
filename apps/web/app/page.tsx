...
const copy = {
  en: {
    ...
    scannerBody: 'The phone opens the scanner PWA. It connects locally to the desktop session through Wi-Fi or USB tethering.',
    ...
    featureOne: 'Wi-Fi and USB tethering',
  ...
  lo: {
    ...
    scannerBody: 'ໂທລະສັບເປີດ PWA scanner ແລະເຊື່ອມຕໍ່ກັບ desktop ຜ່ານ Wi-Fi ຫຼື USB tethering.',
    ...
    featureOne: 'Wi-Fi ແລະ USB tethering',
